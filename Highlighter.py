...
braces      ::  Parentesis, Llaves y Corchetes
...
class Highlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        self.formato_brace.setFontWeight(QFont.Bold)
        self.formato_brace.setForeground(QColor("#d4ac0d").lighter(115))
        ...
        self.formato_comment.setForeground(Qt.darkGreen)
        self.formato_self.setForeground(QColor("#29b6f6").darker(150))
        self.formato_numeros.setFontItalic(True)
        self.formato_numeros.setForeground(QColor("#e0f773"))
        ...
        self._mappings += [(r'%s' % b, 0, self.formato_brace)
        ...
        self._mappings += [
            ...
            (r'\b[+-]?[0-9]+[lL]?\b', 0, self.formato_numeros),
            (r'\b[+-]?0[xX][0-9A-Fa-f]+[lL]?\b', 0, self.formato_numeros),
            (r'\b[+-]?[0-9]+(?:\.[0-9]+)?(?:[eE][+-]?[0-9]+)?\b', 0, self.formato_numeros),
            (r'(?<=^|\s)#.*(?=["\']|$)', 0, self.formato_comment),
